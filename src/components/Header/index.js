import {NavContainer,LogoImage,NavigatorLink,ListItemsLg,Items,LargeDevice} from './styledComponents'
        ...
        return(
            <NavContainer isBlur={blurBg} onScroll={this.changeNavbarColor()}>
                ...
                <ListItemsLg>
                    ...
                    <Items to="experienceSection" spy={true} smooth={true} duration={900} activeClass="active">Work Expereince</Items>
